...
WORKFLOWS = {
    ...
    "pasta fresca": ApplicationWorkflow(
        ...
        primary_metrics=("cooking_loss_pct", "firmness_index", "water_absorption_pct", "protein_pct"),
        ranking_command=None,
        dossier_command=None,
        ...
        next_requirements=(
            "Document pasta metrics, targets, processing assumptions, and confidence limits.",
            "Implement a pasta-specific ranking or evaluation path only after evidence review.",
        ),
    ),
}
